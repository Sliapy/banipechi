...
<?php if ($thumb || $images) { ?>
	...
	<?php if ($images || $video) { ?>
	<?php if ($video_type && $video && ($video_type == 1 || $video_type == 3)) { ?>
		<?php $addvideo = array('popup'=>'https://www.youtube.com/watch?v='.$video,'thumb'=> $thumb_video,'video'=> '1'); ?>
		<?php array_push($images, $addvideo); ?>
	<?php } ?>
	...
	<?php } else { ?>
			<div class="image-additional"><a class="thumbnail imglink mfp-iframe" href="<?php echo $image['popup']; ?>" title="<?php echo $heading_title; ?>" >
			<span class="v_thumb_block"><img src="<?php echo $image['thumb']; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" /><span class="icon-play"></span></span></a></div>
	<?php } ?>
...
<?php if ($attribute_groups) { ?>
	...
	<?php } ?>
		...
		<?php if ($video_type && ($video || $videos) && ($video_type == 2 || $video_type == 3)) { ?>
			<li><a id="videotab" href="#tab-video" data-toggle="tab"><h2><?php echo $tab_video; ?></h2></a></li>
    		<?php } ?>
	

		<?php if ($article_review_tab) { ?>
			<li><a href="#tab-article-review" data-toggle="tab"><?php echo $tab_article_review; ?></a></li>
    		<?php } ?>
...
<div class="tab-pane active" id="tab-description" itemprop="description">
		...
		<?php if ($video_type && ($video || $videos) && ($video_type == 4)) { ?>

			<?php if ($video_size == 1) { ?>
				<?php $video_size_class = "video-size-medium"; ?>
		    	<?php } elseif ($video_size == 2) { ?>
				<?php $video_size_class = "video-size-large"; ?>
		    	<?php } else { ?>
				<?php $video_size_class = "video-size-auto"; ?>
			<?php } ?>
			...
			<?php $total_videos = count($videos); ?>
				...
				<?php if ($total_videos == 1 && $video_size != 3) { ?>
				<div class="<?php echo $video_size_class; ?>">
					<div class="video-container"><iframe src="https://www.youtube.com/embed/<?php echo $videos[0]['id']; ?>?rel=0" frameborder="0" allowfullscreen></iframe></div>
				</div>
				...
				<?php } else { ?>
		 		   ...
		 		   <ul class="video-thumbnails">
		 	            ...
		 	            <li class="video-additional"><a class="thumbnail" href="//www.youtube.com/watch?v=<?php echo $video['id']; ?>"><div class="video-title"><h4><?php echo $video['title']; ?></h4></div><span class="v_thumb_block"><img src="<?php echo $video['thumb']; ?>" alt="<?php echo $video['title']; ?>" /><span class="play"></span></span></a></li>
		 	            <?php } ?>
		 	          </ul>
		...
		<?php } else { ?>
			...
			<?php if ($video_size == 3) { ?>
			   ...
			   <ul class="video-thumbnails">
		            <li class="video-additional"><a class="thumbnail" href="//www.youtube.com/watch?v=<?php echo $video; ?>"><div class="video-title"><h4><?php echo $default_video_title; ?></h4></div><span class="v_thumb_block"><img src="<?php echo $tab_thumb_video; ?>" alt="<?php echo $default_video_title; ?>" /><span class="play"></span></span></a></li>
		          </ul>
...
<?php if ($attribute_groups) { ?>
	...
	<?php } ?>
		...
		<?php if ($video_type && ($video || $videos) && ($video_type == 2 || $video_type == 3)) { ?>
			...
			<?php if (strip_tags($video_description)) { ?>
				<div class="video-description"><?php echo $video_description; ?></div>
			<?php } ?>
			...
			<?php $total_videos = count($videos); ?>
				...
				<script type="text/javascript"><!--
					$('#videotab').click(function() {
					        $('.video-container').html('<iframe src="https://www.youtube.com/embed/<?php echo $videos[0]['id']; ?>?rel=0" frameborder="0" allowfullscreen></iframe>');
					});
				//--></script>			
				<?php } else { ?>
		...
		<?php } else { ?>
			...
			<script type="text/javascript"><!--
				$('#videotab').click(function() {
				        $('.video-container').html('<iframe src="https://www.youtube.com/embed/<?php echo $video; ?>?rel=0" frameborder="0" allowfullscreen></iframe>');
				});
			//--></script>		
			<?php } ?>
		...
		<?php if ($article_review_tab) { ?>
			<div class="tab-pane" id="tab-article-review">
				<div class="article-block">
					<a href="<?php echo $article_review_link; ?>">
						<img src="<?php echo $article_review_image; ?>" class="img-responsive" alt="<?php echo $article_review_name; ?>">
						<div class="article-go"><i class="fa fa-hand-o-up" aria-hidden="true"></i></div>
						<div class="article-name"><h4><?php echo $article_review_name; ?></h4></div>
					</a>
				</div>
			</div>
		<?php } ?>
...
<?= !empty($options_combinations_generic_mode_custom_code) ? $options_combinations_generic_mode_custom_code : ''; ?>
<?php echo $footer; ?>