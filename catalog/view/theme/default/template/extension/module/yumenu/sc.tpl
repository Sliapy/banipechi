<div class="<?php echo $sc_box_class; ?>" id="sc-<?php echo $module; ?>">
  ...
  <div class="sc-expanded"><?php echo $title; ?></div>
            ...
            foreach ($items as $item) {
              ...
              if ($view == 'grid' || $view == 'list' && $i == '1') {
                ...
                if ($item['img'] ) {
                  ...
                  echo '<div class="sc-image"><img srcset="data:image/svg+xml;charset=utf-8,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%20194%2069%27%2F%3E" class="demilazyload" src="'.$item['img'].'" alt="'.$item['title'].'" title="'.$item['title'].'" /></div>';
